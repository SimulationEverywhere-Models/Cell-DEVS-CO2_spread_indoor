The following programs are written in Python 3. Some of the following code requires 3rd party modules to run which are specified in each program's reqpective documentation (PDF).
